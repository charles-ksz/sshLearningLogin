...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">添加图书</h1>
            ...
            <a href="successManage.jsp"  >返回主页</a> <br/>
            <form action="addBook" method="post">
                ...
                图书编号：<input type="text" name="book.bookid" /><br/>
                图书类型：<input type="text" name="book.type"/><br/>
                库存数量：<input type="text" name="book.allmount"/><br/>
                单价：<input  type="text" name="book.price"/><br/>
                图书简介：<input type="text" name="book.remark"/><br/>
