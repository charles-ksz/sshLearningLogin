        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <a href="manager_edit.action?manager.username=${manager.username}"><i class="fa fa-flash "></i>账户管理</a>
                </li>
                <li>

                    <a href="user_list.action?manager.username=${manager.username}"><i class="fa fa-flash "></i>查看用户</a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bicycle "></i>图书操作 <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">

                        <li>


                            <a href="mListBook.action?manager.username=${manager.username}"><i class="fa fa-desktop "></i>图书查看</a>
                        </li>
                        <li>


                            <a href="addBook.jsp?manager.username=${manager.username}"><i class="fa fa-code "></i>添加图书</a>
                        </li>
                ...
                <li>
                    ...
                    <a href="compensate.jsp?manager.username=${manager.username}"><i class="fa fa-anchor "></i>用户赔偿填写</a>
                </li>
